...
import {Panel,Modal,Button,Icon,Cell,Input} from 'dragon-mobile-ui'; // react移动端UI组件
import { fetchJson } from 'src/utils/fetch'; // ajax请求
import StaticToast from 'src/components/common/Toast'; // Toast
import Nav from 'src/components/common/Nav'; // 导航组件
import Empty from 'src/components/common/Empty'; // 空组件
import format from "src/utils/format"; // 格式化工具类
