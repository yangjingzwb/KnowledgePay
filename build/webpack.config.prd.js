...
const OptimizeCssreleasePlugin = require('optimize-css-release-webpack-plugin');
...
/*config.plugins.push(new OptimizeCssreleasePlugin({
...
config.plugins.push(new HtmlWebPackPlugin({
  filename: path.resolve(__dirname, '../release/index.html'), //输出
  minify:{ //压缩HTML文件　
...
config.plugins.push(new CopyWebpackPlugin([
   {
     ...
     to : path.resolve(__dirname, '../release/json'),//定义要拷贝的目标目录  __dirname + ‘/dist’
